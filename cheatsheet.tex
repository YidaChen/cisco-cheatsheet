...
\textit{Note: The same commands are used for Multi-Area OSPF, except that there are more area's. Carefully look which device belong's to which area }\\
...
\textit{Note: to verify Single-Area OSPFv3 please use the ipv6 command}\\
